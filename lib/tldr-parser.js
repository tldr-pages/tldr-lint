...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,8],$V1=[5,13],$V2=[1,5,8,23],$V3=[2,13],$V4=[8,23],$V5=[2,16],$V6=[1,20],$V7=[1,5,8,13,23],$V8=[5,26],$V9=[1,36],$Va=[1,5,8,23,26],$Vb=[26,28,29];
...
productions_: [0,[3,4],[3,3],[3,4],[4,2],[4,1],[6,1],[6,2],[11,2],[11,3],[12,4],[12,3],[12,5],[7,0],[7,2],[19,4],[20,0],[20,1],[21,2],[21,1],[22,1],[22,2],[25,3],[27,0],[27,2],[27,2]],
...
case 9:
  if (this.topState() === 'example_description') {
    ...
    // 1. Any word at the start of a sentence that ends with "ing" and is 6 or more characters long is likely a verb in the gerund (e.g. executing, writing)
    // 2. Any word at the start of a sentence that doesn't end with "us", "ss", or "ys" is likely a verb in the present tense (e.g. superfluous, success, always)
