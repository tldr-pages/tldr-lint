...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,8],$V1=[5,14],$V2=[1,5,8,26],$V3=[2,15],$V4=[8,26],$V5=[2,18],$V6=[1,21],$V7=[1,5,8,14,26],$V8=[5,29],$V9=[1,39],$Va=[1,5,8,26,29],$Vb=[29,31,32];
var parser = {trace: function trace () { },
yy: {},
symbols_: {"error":2,"page":3,"title":4,"NEWLINE":5,"info":6,"examples":7,"TEXT":8,"HASH":9,"TITLE":10,"description":11,"information_link":12,"see_also":13,"GREATER_THAN":14,"DESCRIPTION_LINE":15,"INFORMATION_LINK":16,"ANGLE_BRACKETED_URL":17,"END_INFORMATION_LINK_URL":18,"END_INFORMATION_LINK":19,"SEE_ALSO":20,"END_SEE_ALSO":21,"example":22,"maybe_newline":23,"example_description":24,"example_commands":25,"DASH":26,"EXAMPLE_DESCRIPTION":27,"example_command":28,"BACKTICK":29,"example_command_inner":30,"COMMAND_TEXT":31,"COMMAND_TOKEN":32,"$accept":0,"$end":1},
terminals_: {2:"error",5:"NEWLINE",8:"TEXT",9:"HASH",10:"TITLE",14:"GREATER_THAN",15:"DESCRIPTION_LINE",16:"INFORMATION_LINK",17:"ANGLE_BRACKETED_URL",18:"END_INFORMATION_LINK_URL",19:"END_INFORMATION_LINK",20:"SEE_ALSO",21:"END_SEE_ALSO",26:"DASH",27:"EXAMPLE_DESCRIPTION",29:"BACKTICK",31:"COMMAND_TEXT",32:"COMMAND_TOKEN"},
productions_: [0,[3,4],[3,3],[3,4],[4,2],[4,1],[6,1],[6,2],[6,2],[11,2],[11,3],[12,4],[12,3],[12,5],[13,3],[7,0],[7,2],[22,4],[23,0],[23,1],[24,2],[24,1],[25,1],[25,2],[28,2],[28,3],[30,1],[30,1],[30,2],[30,2]],
...
break;
case 14:
this.$ = yy.addDescription($$[$0-1] + $$[$0].trim());
break;
case 17:
...
table: [{3:1,4:2,8:[1,4],9:[1,3]},{1:[3]},{5:[1,5],6:6,11:7,14:$V0},{10:[1,9]},o($V1,[2,5]),{6:10,8:[1,11],11:7,14:$V0},o($V2,$V3,{7:12}),o($V2,[2,6],{12:13,13:14,14:[1,15]}),{15:[1,16]},o($V1,[2,4]),o($V2,$V3,{7:17}),o($V2,$V3,{7:18}),o($V4,$V5,{22:19,23:20,1:[2,2],5:$V6}),o($V2,[2,7],{14:[1,22]}),o($V2,[2,8]),{15:[1,23],16:[1,24],20:[1,25]},o($V7,[2,9]),o($V4,$V5,{22:19,23:20,1:[2,1],5:$V6}),o($V4,$V5,{22:19,23:20,1:[2,3],5:$V6}),o($V2,[2,16]),{8:[1,28],24:26,26:[1,27]},o([8,26,29],[2,19]),{16:[1,29]},o($V7,[2,10]),{17:[1,30],19:[1,31]},{21:[1,32]},{5:$V6,23:33,29:$V5},{27:[1,34]},o($V8,[2,21]),{17:[1,35]},{18:[1,36]},o($V7,[2,12]),o($V2,[2,14]),{25:37,28:38,29:$V9},o($V8,[2,20]),{18:[1,40]},o($V7,[2,11]),o($V2,[2,17],{28:41,29:$V9}),o($Va,[2,22]),{29:[1,42],30:43,31:[1,44],32:[1,45]},o($V7,[2,13]),o($Va,[2,23]),o($Va,[2,24]),{29:[1,46],31:[1,47],32:[1,48]},o($Vb,[2,26]),o($Vb,[2,27]),o($Va,[2,25]),o($Vb,[2,28]),o($Vb,[2,29])],
defaultActions: {},
...
case 6:
  ...
  if (this.matches[1] !== 'See also: ') {
    yy.error(yy_.yylloc, 'TLDR022');
  }
  this.popState();
  this.pushState('see_also');
  return 20;
...
case 8:
  if (this.topState() === "title") {
    ...
    this.popState();
    return 19;
  } else if (this.topState() === 'see_also') {
    this.checkTrailingWhitespace(this.matches[2], yy_.yylloc);
    this.checkNewline(this.matches[3], yy_.yylloc);
    this.popState();
    return 21;
...
rules: [/^(?:\s+$)/,/^(?:.*?\t+.*)/,/^(?:[^\n]$)/,/^(?:(\s*)#(\s*))/,/^(?:([\>-])(\s*))/,/^(?:([Mm]ore\s+[Ii]nfo(?:rmation)?:?\s*))/,/^(?:([Ss]ee\s+[Aa]lso:?\s*))/,/^(?:(<https?:\/\/[^\s\>]*>))/,/^(?:(.+?)([ ]*)((?:\r\n)|\n|\r))/,/^(?:(.+?)([\.,;!\?]?)([ ]*)((?:\r\n)|\n|\r))/,/^(?:(.+?)([\.:,;]?)([ ]*)((?:\r\n)|\n|\r))/,/^(?:`((?:\r\n)|\n|\r))/,/^(?:`([ ]*))/,/^(?:\{\{([^\n\`\{\}]*)\}\}(((?:\r\n)|\n|\r)?))/,/^(?:([^\`\n]+?)\{\{)/,/^(?:([^\`\n]+?)(`[ ]*|[ ]*((?:\r\n)|\n|\r)))/,/^(?:[ ]+)/,/^(?:((?:\r\n)|\n|\r)+)/,/^(?:(.+?)[\.:]?((?:\r\n)|\n|\r))/],
...
exports.parse = function () { return tldrParser.parse.apply(tldrParser, arguments); };
