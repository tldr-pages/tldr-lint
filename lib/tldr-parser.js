...
*/
var parser = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,8],$V1=[1,7],$V2=[5,10,11],$V3=[1,5,10,17],$V4=[2,8],$V5=[1,12],$V6=[1,5,10,11,17],$V7=[10,17],$V8=[2,11],$V9=[1,17],$Va=[5,20],$Vb=[1,26],$Vc=[1,5,10,17,20],$Vd=[20,22,23];
var parser = {trace: function trace() { },
yy: {},
symbols_: {"error":2,"page":3,"title":4,"NEWLINE":5,"description":6,"examples":7,"HASH":8,"TITLE":9,"TEXT":10,"GREATER_THAN":11,"DESCRIPTION_LINE":12,"example":13,"maybe_newline":14,"example_description":15,"example_commands":16,"DASH":17,"EXAMPLE_DESCRIPTION":18,"example_command":19,"BACKTICK":20,"example_command_inner":21,"COMMAND_TEXT":22,"COMMAND_TOKEN":23,"$accept":0,"$end":1},
terminals_: {2:"error",5:"NEWLINE",8:"HASH",9:"TITLE",10:"TEXT",11:"GREATER_THAN",12:"DESCRIPTION_LINE",17:"DASH",18:"EXAMPLE_DESCRIPTION",20:"BACKTICK",22:"COMMAND_TEXT",23:"COMMAND_TOKEN"},
productions_: [0,[3,4],[3,3],[4,2],[4,1],[6,2],[6,3],[6,1],[7,0],[7,2],[13,4],[14,0],[14,1],[15,2],[15,1],[16,1],[16,2],[19,3],[21,0],[21,2],[21,2]],
...
break;
case 7:
this.$ = yy.error(this._$, 'TLDR101') || yy.addDescription($$[$0], _$[$0]);
break;
case 10:
 
              yy.addExample($$[$0-2], $$[$0], _$[$0-2]);
...
table: [{3:1,4:2,8:[1,3],10:[1,4]},{1:[3]},{5:[1,5],6:6,10:$V0,11:$V1},{9:[1,9]},o($V2,[2,4]),{6:10,10:$V0,11:$V1},o($V3,$V4,{7:11,11:$V5}),{12:[1,13]},o($V6,[2,7]),o($V2,[2,3]),o($V3,$V4,{7:14,11:$V5}),o($V7,$V8,{13:15,14:16,1:[2,2],5:$V9}),{12:[1,18]},o($V6,[2,5]),o($V7,$V8,{13:15,14:16,1:[2,1],5:$V9}),o($V3,[2,9]),{10:[1,21],15:19,17:[1,20]},o([10,17,20],[2,12]),o($V6,[2,6]),{5:$V9,14:22,20:$V8},{18:[1,23]},o($Va,[2,14]),{16:24,19:25,20:$Vb},o($Va,[2,13]),o($V3,[2,10],{19:27,20:$Vb}),o($Vc,[2,15]),o($Vd,[2,18],{21:28}),o($Vc,[2,16]),{20:[1,29],22:[1,30],23:[1,31]},o($Vc,[2,17]),o($Vd,[2,19]),o($Vd,[2,20])],
defaultActions: {},
...
case 7:
  if (this.topState() === 'example_description') {
    ...
    if (yy_.yytext.match(/(^[A-Za-z]{3,}ing )|(^[A-Za-z]+[^us]s )/)) {
...
break;
case 15:this.signalEOF(yy_.yylloc, yy_.yylineno)
break;
}
},
rules: [/^(?:\s+$)/,/^(?:.*?\t+.*)/,/^(?:[^\n]$)/,/^(?:(\s*)#(\s*))/,/^(?:([\>-])(\s*))/,/^(?:(.+)((?:\r\n)|\n|\r))/,/^(?:(.+?)([\.,;!\?]?)((?:\r\n)|\n|\r))/,/^(?:(.+?)([\.:,;]?)((?:\r\n)|\n|\r))/,/^(?:`((?:\r\n)|\n|\r))/,/^(?:`)/,/^(?:\{\{([^\n\`\{\}]*)\}\}(((?:\r\n)|\n|\r)?))/,/^(?:([^\`\n]+?)\{\{)/,/^(?:([^\`\n]+?)(`|((?:\r\n)|\n|\r)))/,/^(?:((?:\r\n)|\n|\r)+)/,/^(?:(.+?)[\.:]?((?:\r\n)|\n|\r))/,/^(?:$)/],
