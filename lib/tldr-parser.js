...
case 9:
  if (this.topState() === 'example_description') {
    ...
    var infinitiveExceptions = ['antialias', 'alias', 'bias', 'canvas', 'focus', 'gas'];
    var firstWord = yy_.yytext.replace(/^\W*/, '').split(/\s+/)[0].toLowerCase();
    if (yy_.yytext.match(/(^[A-Za-z]{3,}ing )|(^[A-Za-z]+[^usy]s )/) && !infinitiveExceptions.includes(firstWord)) {
