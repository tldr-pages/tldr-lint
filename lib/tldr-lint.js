...
module.exports.ERRORS = parser.ERRORS = {
  ...
  'TLDR022': 'Page should not contain the Unicode hyphen character (U+2010); use an ASCII hyphen-minus (-) instead',
...
linter.process = function(file, page, verbose, alsoFormat) {
  ...
  page.split(/\r\n|\r|\n/).forEach(function(line, index) {
    if (line.includes('‐')) {
      parser.yy.errors.push({ locinfo: { first_line: index + 1 }, code: 'TLDR022', description: linter.ERRORS.TLDR022 });
    }
  });
  if (verbose) {
